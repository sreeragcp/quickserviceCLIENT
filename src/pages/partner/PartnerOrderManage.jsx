...
import { functionRequestAccept } from "../../services/Apis";
import { functionRequestReject } from "../../services/Apis";
import { funtionGenerateOtp } from "../../services/Apis";
import { functionVerifyOtp } from "../../services/Apis";
import { functionCurrentBooking } from "../../services/Apis";
...
const PartnerOrderManage = () => {
    ...
    const partner = localStorage.getItem("partnerData");
    ...
    console.log(email, "this is the userEmail");
    ...
    const getBookingData = async () => {
      ...
      try {
        ...
        console.log(partnerId, "this sit eh partner id");
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-3/4">
          ...
          <div className="flex justify-between mt-4 h-32 ">
            {otpPage ? (
              ...
              //    <div className=" w-52 overflow-hidden bg-white rounded-lg shadow-lg">
              //           <h1 className="ml-16 text-sm font-normal text-emerald-500">Enter OTP</h1>
              ...
              //     <div>
              //         <button
              //           className="ml-20 mt-4 w-12 h-7 border rounded-xl outline-none  bg-blue-700 border-none text-white text-sm shadow-sm"
              //           onClick={verfyOtp}
              //         >
              //           Verify
              //         </button>
              ...
              //   </div>
              //   </form>
              <div className="w-52 h-44 border border-black">
                <form action="" method="post">
          ...
          <div className="flex justify-end mr-3 mt-3">
            <div>
              <button
                ...
                on
                className=" w-16 h-8 rounded-md text-white bg-green-400 border border-black"
              >
                Accept
              </button>
            </div>
            <div>
              <button
                ...
                className="ml-3 w-16 h-8 rounded-md text-white bg-red-500 border border-black"
              >
                Reject
              </button>
            </div>
                  ...
                  <div className="origin-top-right absolute right-0 mt-2 mr-10 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                    <div className="py-1">
                      <button
                        ...
                        className="block px-4 py-2 text-white w-full bg-green-100 hover:bg-green-200 focus:outline-none"
                      >
                        Packed
                      </button>
                      <button
